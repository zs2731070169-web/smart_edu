...
def load_tf_weights_in_ernie_m(model, config, tf_checkpoint_path):
    ...
    for name, array in zip(names, arrays):
        ...
        # which are not required for using finetuning model
        if any(
...
class ErnieMPreTrainedModel(PreTrainedModel):
    """
    An abstract class to handle weights initialization and a simple interface for downloading and loading finetuning
    models.
    """
